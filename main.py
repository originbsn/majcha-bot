...
- ถ้าถามเปิดสงกรานต์มั้ย/วันหยุดพิเศษช่วงสงกรานต์: บอกว่าเปิดปกติค่ะ 11.00-22.00 น.
- ถ้าถามโปร/ส่วนลด:
...
- ถ้าลูกค้าถามแมนูนำ เมนูอย่างละ 2-3 อย่างในแต่ละหมวดหมู่โดยไม่ต้องให้เมนูของหวานและน้ำ และปิดท้ายด้วย link ดูเมนู
...
def get_ai_reply(user_id, user_text):
    ...
    try:
        ...
        return "คอนนี้ไม่สะดวกตอบ ถ้าลูกค้าต้องการข้อมูลเพิ่มเติมหรือจองโต๊ะ แนะนำให้โทร 081-7514044 ก่อนโต๊ะเต็มนะคะ 🙏"
